...
def display_header():
    ...
    try:
        with open("avni.jpg", "rb") as img_file:
            logo_base64 = base64.b64encode(img_file.read()).decode()
            logo_html = f'<img src="data:image/jpeg;base64,{logo_base64}" alt="Avni Logo" class="logo-image" style="max-height: 100px;">'
    except:
...
def display_analysis_results(analysis_result):
    ...
    with col2:
        report_content = f"""
# Avni Recruitment - Resume Analysis Report
    ...
    if st.button("Generate Interview Questions"):
        if generate_questions_func:
            with st.spinner("Generating personalized interview questions..."):
                ...
                # Add Avni branding to download content
    ...
    if st.button("Generate Resume Improvements"):
        if improve_resume_func:
            with st.spinner("Analyzing and generating improvements..."):
                ...
                # Add Avni branding to download content
                download_content += "\n---\nProvided by Avni - Recruitment Agent"
